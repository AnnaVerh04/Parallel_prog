...
int main() {
    ...
    ofstream time_output("results2/time_results2.txt");
    ...
    for (int size : sizes) {
        ...
        string matrixA_file = "matrices2/matrixA_" + to_string(size) + ".txt";
        string matrixB_file = "matrices2/matrixB_" + to_string(size) + ".txt";
        ...
        string resultFile = "results2/result_" + to_string(size) + ".txt";
